...
public class MyData {
    ...
    static String[] servicoArray = {"Corte", "Alisamento", "Escova", "Tintura", "Manicure/PERDICURE"};
    static String[] eslogamArray = {"Todos Tipos", "Todos os cabelos", "Especialista", "Padrão", "Tratamento"};
    static Integer[] imagemArray = {R.drawable.cupcake, R.drawable.donut, R.drawable.eclair,
            R.drawable.froyo, R.drawable.gingerbread};
    static Integer[] idArray = {3, 4, 5, 6, 7};
}
