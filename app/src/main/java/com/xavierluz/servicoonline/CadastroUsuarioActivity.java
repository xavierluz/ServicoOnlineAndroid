                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(findViewById(R.id.activity_cadastro_usuario), "Falha ao criar o usuário", Snackbar.LENGTH_LONG).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Snackbar.make(findViewById(R.id.activity_cadastro_usuario), "Falha ao autenticar o usuário", Snackbar.LENGTH_LONG).show();
